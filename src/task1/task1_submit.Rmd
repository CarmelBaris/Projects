...
b. On the scatter plot we can see all of the outliers, they are marked in red. The outliers are calculated based on the mean and standard deviation of a dataset and marking data points that are more than a 5 standard deviations away from the mean.
c. We can see on the scatter plot the actual locations of the outliers on the chromosome. \n
