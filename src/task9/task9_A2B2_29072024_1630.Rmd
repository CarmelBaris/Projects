...
cat("Tumor Pre-Fix   ", round(mean(tumor_pre_fix, na.rm = TRUE),3), "\n")
cat("Tumor Post-Fix  ", round(mean(tumor_post_fix, na.rm = TRUE),3), "\n\n")
cat("Healthy Pre-Fix ", round(mean(healthy_pre_fix, na.rm = TRUE),3), "\n")
cat("Healthy Post-Fix", round(mean(healthy_post_fix, na.rm = TRUE),3), "\n")
