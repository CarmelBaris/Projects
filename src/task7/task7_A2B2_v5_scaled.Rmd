...
mod_2n_old = lm(reads2.5K_n2_normalized~bs(GC, degree = 3),subset = reads2.5K_n2_normalized>1.5 & reads2.5K_n2_normalized<35 )

pred_range = seq(0.2,0.75,0.01)
resp_n = predict(mod_2n_old,list(GC=pred_range))
preds2n = predict(mod_2n_old,list(GC=GC2.5K_clean))
