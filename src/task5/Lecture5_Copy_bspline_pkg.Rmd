...
```{r}
bspline_mod = lm(y~bs(x,knots = c(-2,2), degree=1))
...
library('Metrics') 
m.mse = mse(ytest,predict(lm_17,test_dat))
m.mae = mae(ytest,predict(lm_17,test_dat))
print(sprintf( "RMSPEs d=17: Test MSE %.3f Test MAE %.3f",m.mse,m.mae))
