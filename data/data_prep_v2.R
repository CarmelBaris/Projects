...
# Load nucleobases data
bases_file = file.path(dir_name, "chr1_line.rda")
chr1_bases = helpers$loadRData(bases_file)

# Load reads data
reads_100_A2 = helpers$loadRData(file.path(dir_name, "reads_100_A2.rda"))
reads_100_B2 = helpers$loadRData(file.path(dir_name, "reads_100_B2.rda"))
GC_100       = helpers$loadRData(file.path(dir_name, "GC_100.rda"))
# chr1t_mat    = matrix(reads_100_A2, nr = 50)


# Preprocess data
nreads = nrow(reads_B2_100)
