...
# Rescaling the view
Obviously problematic because the most extreme outliers force us to smush all the other observations at the bottom of the graph, in order to maintain the scaled distance from the uppermost outlier. \n
...
$$ \textit{e}_i \text{ Part of this text is written in } \textit{italic} $$
...
grp = 1+(GC_5K>lwr_seg)+(GC_5K>upr_seg)

# count number of observations per segment
knitr::kable(table(grp), col.names = c("Segment","#Dots"))
