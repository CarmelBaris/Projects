...
## Plotting before\after removing outliers
```{r}
par(mfcol=c(2,1))
plot(GC_5K,reads_5K,ylim=c(0,800))
plot(GC_5K_clean,reads_5K_clean, xlim = c(0,0.75))
par(mfcol=c(1,1))
```
...
lwr_knot = breakpoints[[1]]
upr_knot = breakpoints[[2]]
...
# Plot knots
abline(v=c(lwr_knot,upr_knot),lt=2, col = rgb(1,0,0.5,0.25), lwd = 1.5)
