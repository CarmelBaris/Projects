...
# scatter plot: GC percentages vs Coverage

First attempt

```{r}
# limited y axis, selected smaller points & higher transparency of filling
plot(GC_5K,reads_5K, ylim = c(0,500),cex = 0.5,col=rgb(0,0,0,0.2))
```
...
# important to set seed ! to ensure that randomized sampling is reproducible
set.seed(100) 

#select a randomized subset of data points 
