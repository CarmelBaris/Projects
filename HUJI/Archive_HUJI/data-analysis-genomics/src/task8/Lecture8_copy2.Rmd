...
plot(corrected_1n[range_a], ylab = "Healthy",
     main = "After GC ('One Sample') Correction",
     ylim = c(0,3), cex = 0.2, pch=20)
abline(h=1, col=4, lwd = 1.5)
...
two_sample_wout_gc = two_sample_correct_e(uncorrected_1t,uncorrected_1n,10000)
two_sample_wout_gc_or_eps = two_sample_correct_e(uncorrected_1t,uncorrected_1n,0)
...
plot(two_sample_wout_gc[range_a],
     ylim = c(0,2.5),cex = 0.2,pch=20)
abline(h=1,col=4)
plot(two_sample_wout_gc_or_eps[range_a],
     ylim = c(0,2.5),cex = 0.2,pch=20)
abline(h=1,col=4)
