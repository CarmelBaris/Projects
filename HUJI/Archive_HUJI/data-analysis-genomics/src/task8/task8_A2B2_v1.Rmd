...
reads2.5K_n2_clean = scales::rescale(reads2.5K_n2_clean, to = c(0, 1000000))
...
plot(GC2.5K_clean[samp1], reads2.5K_n2_clean[samp1], cex = 0.4, pch = 20, ylab = "Healthy 2", ylim = c(0, 350000), xlim = c(0.2, 0.75))
...
mod_2n = lm(reads2.5K_n2_clean~bs(GC, degree = 3),subset = reads2.5K_n2_clean>150000 & reads2.5K_n2_clean<350000 )
...
plot(GC2.5K_clean[samp1],reads2.5K_n2_clean[samp1],ylim = c(0,350000),xlim = c(0.2,.75), cex = 0.5, pch=20, main = "Healthy 2")
...
```{r med_fix}
fixed_2n_gc_med_eps = one_sample_correct (reads2.5K_n2_clean,preds2n[1:l_2n])
unfixed_2n_gc_med_eps = (reads2.5K_n2_clean)/median(reads2.5K_n2_clean) 

fixed_2t_gc_med_eps = one_sample_correct (reads2.5K_t2_normalized,preds2t[1:l_2t])
unfixed_2t_gc_med_eps = (reads2.5K_t2_normalized)/median(reads2.5K_t2_normalized) 
...
plot(fixed_2n_gc_med_eps[range_a], ylim = c(0,2.5), cex = 0.5, pch=20, ylab = "Healthy 2", main = "Corrected")
abline(h=1,col=4)
...
poisson_variance = mean(reads2.5K_n2_clean)/(median(reads2.5K_n2_clean)^2)
...
preds2t = pmax(predict(mod_2t,list(GC=GC2.5K_clean)),0)


# One Sample with espilon, Normative
eps = 0.1

fixed_2n_gc_med_eps = one_sample_gc_correct(reads2.5K_n2_clean, preds1n[1:l_2n], eps)
unfixed_2n_gc_med_eps = one_sample_gc_correct(reads2.5K_n2_clean, rep(1,l_2n), eps)

# One Sample with espilon, Tumor
eps = 0.1
fixed_2t_gc_med_eps = one_sample_gc_correct (reads2.5K_t2_clean,preds2t[1:l_2t],eps)
unfixed_2t_gc_med_eps = one_sample_gc_correct(reads2.5K_t2_clean,rep(1,l_2t),eps)
```
