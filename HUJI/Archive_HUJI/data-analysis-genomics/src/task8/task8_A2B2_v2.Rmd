...
```{r med_fix}
fixed_2n_gc_med_eps = one_sample_correct (reads2.5K_n2_normalized,preds2n[1:l_2n])
unfixed_2n_gc_med_eps = (reads2.5K_n2_normalized)/median(reads2.5K_n2_normalized) 
...
eps = 0.1
fixed_2t_gc_med_eps = one_sample_gc_correct (reads2.5K_t2_clean,preds1t[1:l_2t],eps)
...
```{r}
par(mfcol = c(3,1),mar = c(0.5,5,2,2))
## two sample median + GC correction
## 
plot(two_samp_med[discontinuous_range], ylab = "Median (Only)", xaxt = "n",
     main = "Two Sample Corrections",
     # xlim = c(0,4000),
     ylim = c(0,2), cex = 0.2, pch=20)
abline(h=1,col=4, lwd = 1.5)
abline(v=4000,col=6,lt = 2, lwd = 1.2)

plot(two_samp_med_eps[discontinuous_range], ylab = "Median+Epsilon", xaxt = "n",
     # xlim = c(0,4000),
     ylim = c(0,2), cex = 0.2, pch=20)
abline(h=1,col=4, lwd = 1.5)
abline(v=4000,col=6,lt = 2, lwd = 1.2)

plot(two_samp_med_gc_eps[discontinuous_range], ylab = "Median+Epsilon+GC", xaxt = "n",
     # xlim = c(0,4000),
     ylim = c(0,2), cex = 0.2, pch=20)
abline(h=1,col=4, lwd = 1.5)
abline(v=4000,col=6,lt = 2, lwd = 1.2)
...
range_c = c(bins[1]:bins[2])
plot(two_samp_med_gc_eps[range_c], xaxt = "n", 
     xlab = "", main = "Three Fixes: Median, GC, Two-Sample w/ Epsilon",
     ylim = c(0,2),cex = 0.2,pch=20)
abline(h=1,col=4, lwd = 1.5)
abline(v=c(1000,1200,4000),col=c(5,5,6), lt=c(1,1,2), lwd = 1.2)

plot(two_samp_med_eps[range_c],xaxt = "n",
     xlab = "", main = "Median + Two-Sample w/ Epsilon",
     ylim = c(0,2),cex = 0.2,pch=20)
abline(h=1,col=4, lwd = 1.5)
abline(v=c(1000,1200,4000),col=c(5,5,6), lt=c(1,1,2), lwd = 1.2)
