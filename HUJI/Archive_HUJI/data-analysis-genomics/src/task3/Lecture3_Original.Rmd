...
Here is a helper function for binning stuff. 
...
```{r}
k = 10
output = bin_reads(ceiling(s_dat), k)
...
```{r}
k = 1
output = bin_reads(ceiling(s_dat[1:1000000]), k)
...
```{r}
k = 1000
output_1K = bin_reads(ceiling(s_dat), k)
```
