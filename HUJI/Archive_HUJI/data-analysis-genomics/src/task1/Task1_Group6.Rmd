...
sum_na <- sum(is.na(chr1_vector)) # returns 0 if no values are missing
paste0("Non-empty nucleobases: ", length(chr1_vector) - sum_na)
format(object.size(chr1_vector), units = "Mb")
format(object.size(chr1_single), units = "Mb")
incl_na = factor(chr1_single, c("A","T","C","G","N"))
table(incl_na)
```
