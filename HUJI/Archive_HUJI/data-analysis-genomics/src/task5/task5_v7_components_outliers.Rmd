...
z_scores = (reads_20K[reads_20K!=0] - mean(reads_20K[reads_20K!=0])) / sd(reads_20K[reads_20K!=0])
...
table_data <- data.frame(
  Outliers_Condition = c("GC=0%", "0%<GC<30%", "0 Reads", "Xtreme Reads", "Reads<200", "Confounders","Total Outliers", "Total Observations"),
  Num_Observed = values,
