...
train_div1 <- data.frame(GC_20K = GC_20K_clean[train_logical_div1], reads_20K = reads_20K_clean[train_logical_div1])
train_div2 <- data.frame(GC_20K = GC_20K_clean[train_logical_div2], reads_20K = reads_20K_clean[train_logical_div2])
train_div3 <- data.frame(GC_20K = GC_20K_clean[train_logical_div3], reads_20K = reads_20K_clean[train_logical_div3])

# Define knots for the B-spline
knots_bs <- c(0.415, 0.45, 0.54)

# Fit the B-spline model using the train data for each division
reg_bs_train_div1 <- lm(reads_20K ~ bs(GC_20K, knots = knots_bs, degree = 3, Boundary.knots = c(min(GC_20K_clean), max(GC_20K_clean))), data = train_div1)
reg_bs_train_div2 <- lm(reads_20K ~ bs(GC_20K, knots = knots_bs, degree = 3, Boundary.knots = c(min(GC_20K_clean), max(GC_20K_clean))), data = train_div2)
reg_bs_train_div3 <- lm(reads_20K ~ bs(GC_20K, knots = knots_bs, degree = 3, Boundary.knots = c(min(GC_20K_clean), max(GC_20K_clean))), data = train_div3)
...
points(test_div1$GC_20K, test_div1$reads_20K, col = rgb(0, 0, 1, 0.5), pch = 1)
points(test_div1$GC_20K, test_div1$predicted, col = rgb(0, 0, 1, 0.5), pch = 16)
segments(test_div1$GC_20K, test_div1$reads_20K, test_div1$GC_20K, test_div1$predicted, col = rgb(0, 0, 1, 0.3), lty = 2)

points(test_div2$GC_20K, test_div2$reads_20K, col = rgb(1, 0, 0, 0.5), pch = 1)
points(test_div2$GC_20K, test_div2$predicted, col = rgb(1, 0, 0, 0.5), pch = 16)
segments(test_div2$GC_20K, test_div2$reads_20K, test_div2$GC_20K, test_div2$predicted, col = rgb(1, 0, 0, 0.3), lty = 2)

points(test_div3$GC_20K, test_div3$reads_20K, col = rgb(0, 1, 0, 0.5), pch = 1)
points(test_div3$GC_20K, test_div3$predicted, col = rgb(0, 1, 0, 0.5), pch = 16)
segments(test_div3$GC_20K, test_div3$reads_20K, test_div3$GC_20K, test_div3$predicted, col = rgb(0, 1, 0, 0.3), lty = 2)
