...
# Division 2
props_div2 = helpers$check_ratio(train_logical_div2, test_logical_div2, 0.7)
cat("Div2 props\n", 
...
# Division 3
props_div3 = helpers$check_ratio(train_logical_div3, test_logical_div3, 0.7)
cat("Div3 props\n", 
...
# Division 1
size_div1 = helpers$check_size(train_logical_div1, test_logical_div1, reads_20K)
paste0("Has Div1 passed size test? ", size_div1)

# Division 2
size_div2 = helpers$check_size(train_logical_div2, test_logical_div2, reads_20K)
paste0("Has Div2 passed size test? ", size_div2)

# Division 3
size_div3 = helpers$check_size(train_logical_div3, test_logical_div3,reads_20K)
