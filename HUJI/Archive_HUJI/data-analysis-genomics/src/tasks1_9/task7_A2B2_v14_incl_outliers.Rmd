...
### Outliers
```{r outliers}
reads_healthy = reads2.5K_n2
reads_tumor = reads2.5K_t2
GC_percent = GC2.5K
```
...
plot(GC_percent[samp1], reads_tumor[samp1], cex = 0.4, pch = 20, ylab = "Tumor Sample", ylim = c(0, 350000), xlim = c(0.2, 0.75))
```
...
```{r}
mod_2t = lm(reads_tumor~bs(GC, degree = 3),subset = (reads_tumor>15000)&(reads_tumor<400000))
...
plot(GC2.5K_clean[samp1],reads_tumor[samp1],ylim = c(0,350000),xlim = c(.2,.75), cex = 0.5, pch=20, main = "Tumor 2")
...
corrected_2t = one_sample_correct (reads_tumor,preds2t[1:l_2t])
uncorrected_2t = (reads_tumor)/median(reads_tumor) 
...
plot(GC2.5K_clean[samp1], reads_tumor[samp1], cex = 0.4, pch = 20, ylab = "Tumor 2", ylim = c(0, 350000), xlim = c(0.2, 0.75))
...
bins = loc2bin(c(27,35,75,80),2500)
