...
# Add legend
legend("topright", legend = c("Tumor Sample", "Healthy Sample"), col = c("darkgray", "lightgray"), lty = 1, lwd = 2, pch = 20)
...
eps = 10
corrected_2n = one_sample_gc_correct(reads2.5K_n2_normalized, preds1n[1:l_2n], eps)
uncorrected_2n = one_sample_gc_correct(reads2.5K_n2_normalized, rep(1,length(reads2.5K_n2_normalized)), eps)

# One Sample with espilon, Tumor
eps = 10
corrected_2t = one_sample_gc_correct (reads2.5K_t2_clean,preds1t[1:l_2t],eps)
uncorrected_2t = one_sample_gc_correct(reads2.5K_t2_normalized,rep(1,length(reads2.5K_t2_normalized)),eps)
```
