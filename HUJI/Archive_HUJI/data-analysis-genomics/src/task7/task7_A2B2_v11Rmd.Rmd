...
range_c = bins[1]:bins[2] & bins[3]:bins[4] 
head(c((25000000/2500):(35000000/2500),(75000000/2500):(80000000/2500)))
c(25000000:35000000,75000000:80000000)/2500
...
plot(two_sample_wout_gc[discontinuous_range],xaxt = "n",
     xlab = "Reads Count per Bin Location (2.5K)",
