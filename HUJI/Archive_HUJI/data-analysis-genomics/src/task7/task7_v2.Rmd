...
GC_100=GC_100[1: (length(reads_100_A1)) ]
```
...
z_scores_n1 = (reads_2.5K_n1 - mean(reads_2.5K_n1)) / sd(reads_2.5K_n1)
z_scores_t1 = (reads_2.5K_t1 - mean(reads_2.5K_t1)) / sd(reads_2.5K_t1)
xtreme_reads_n1 = abs(z_scores_n1) > 2
xtreme_reads_t1 = abs(z_scores_t1) > 2

# create new variables without outliers
outliers = (zeros_GC | small_GC | xtreme_reads_n1 | xtreme_reads_t1 | xtreme_reads_n1)
reads_2.5K_clean_n1 = reads_2.5K_n1 [!outliers]
reads_2.5K_clean_t1 = reads_2.5K_t1[!outliers]
