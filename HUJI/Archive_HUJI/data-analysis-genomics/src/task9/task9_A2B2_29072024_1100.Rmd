...
# Evenly Spaced Knpts
n_knots = 3
myknots = seq(min(GC), max(GC), length.out = n_knots + 2)[-c(1, n_knots + 2)]
```
...
plot(GC[samp1], reads_tumor[samp1], xlim = c(0, 0.6), ylim = c(0, 500))
...
max_read_count <- 5
reads_grouped <- cut(reads_tumor, breaks = c(-Inf, 0:max_read_count, Inf), labels = c(0:max_read_count, paste0(max_read_count, "+")), right = TRUE)
...
barplot(read_hist, ylim = y_lim, yaxt = "n", 
