...
color_tumor = rgb(0.5, 0.5, 0.5, 0.7)
col_healthy = rgb(0.8, 0.8, 0.8, 0.7)
```
...
plot(GC_cln[samp1], scales::rescale(r_health_cln, to = c(0, 400))[samp1], 
     cex = 0.4, pch = 20, col = col_healthy,
     ylim = c(0, 400), xlim = c(0.2, 0.75), 
     xaxt = "n",  main = "Scaled", xlab = "")
plot(GC_cln[samp1], scales::rescale(r_tumor_cln, to = c(0, 400))[samp1], 
     cex = 0.4, pch = 20, col = color_tumor,
     ylim = c(0, 400), xlim = c(0.2, 0.75), 
     ylab = "", xlab = "")
plot(1)
...
plot(two_samp_med_eps0.3_gc[stiched_range], 
     ...
     cex = 0.7, pch=20, col = rgb(0.1, 0.1, 0.1, 0.5))
