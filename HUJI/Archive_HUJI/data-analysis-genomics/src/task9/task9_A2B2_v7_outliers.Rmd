...
plot(GC2.5K, reads2.5K_t2, pch = 20, cex = 0.7, col = rgb(0, 0, 0, 0.5),
     xlab = "GC Content (cleaned)", ylab = "Read Counts (cleaned)",
     ylim = c(mean(reads2.5K_t2), 3000),
     main = "Majority of Outliers")

# Mark outliers
points(GC2.5K[out_t2], reads2.5K_t2[out_t2], col = "red", pch = 20)
points(GC2.5K[out_n2], reads2.5K_t2[out_n2], col = "orange", pch = 20)
...
plot(GC2.5K, reads2.5K_t2, pch = 20, cex = 0.7, col = rgb(0, 0, 0, 0.5),
     xlab = "GC Content (cleaned)", ylab = "Read Counts (cleaned)",
     ylim = c(3000, 5000),
     main = "Outliers Above Upper Quantile (Zoom)")
...
# Add legend
legend("topleft", legend = c("Tumor Outliers", "Healthy Outliers"), col = c("purple", "cyan3"), pch = 20, bty = "n")

# Create the scatter plot
plot(GC2.5K, reads2.5K_n2, pch = 20, cex = 0.7, col = rgb(0, 0, 0, 0.3),
     xlab = "GC Content (cleaned)", ylab = "Read Counts (cleaned)",
     ylim = c(fl_n2, 3*fl_n2),
     main = "Outliers Above Upper Quantile (Zoom)")
...
```{r rm_env}
## ------------------------------------------------
rm("path", "find_out_boxplot","out_n2","out_reads_xtra","out_t2")
